...
const GlintsJobCategoryCard = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await Api.get(`/data-visualization/job-categories?source=glints`)
  ...
  return (
    <Card>
      <div className="flex justify-between items-center mb-4">
        <Text className="font-bold text-xl">Glints Job Category</Text>
...
export default GlintsJobCategoryCard;
