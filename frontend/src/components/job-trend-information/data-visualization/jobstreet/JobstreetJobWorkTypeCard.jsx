...
const JobstreetJobWorkTypeCard = () => {
  ...
  const fetchData = async () => { 
    setloading(true)
    try {
      const response = await Api.get('/data-visualization/job-work-types?source=jobstreet')
...
export default JobstreetJobWorkTypeCard;